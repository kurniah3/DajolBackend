...
class DemoFoodVendorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $vendorImages = [
            'https://source.unsplash.com/800x480/?kfc',
            'https://source.unsplash.com/800x480/?mcdonalds',
            'https://source.unsplash.com/800x480/?burger',
            'https://source.unsplash.com/800x480/?subway'
        ];
        ...
        foreach ($vendorNames as $key => $vendorName) {
            ...
            try {
                $imageUrl = "https://source.unsplash.com/800x480/?" . urlencode($imageUrl);
            ...
            foreach ($vendorFoodList as $foodName) {
                ...
                //
                try {
                    $imageUrl = "https://source.unsplash.com/800x480/?" . urlencode($foodName);
                    $food->addMediaFromUrl($imageUrl)->toMediaCollection();
                } catch (\Exception $ex) {
                    logger("Error", [$ex->getMessage()]);
                }
            }
