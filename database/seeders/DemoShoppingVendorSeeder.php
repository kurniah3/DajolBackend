...
class DemoShoppingVendorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $vendorImages = [
            'https://source.unsplash.com/800x480/?nike',
            'https://source.unsplash.com/800x480/?adidas',
            'https://source.unsplash.com/800x480/?puma',
            'https://source.unsplash.com/800x480/?reebok',
            'https://source.unsplash.com/800x480/?gucci',
            'https://source.unsplash.com/800x480/?louis-vuitton',
            'https://source.unsplash.com/800x480/?zara',
            'https://source.unsplash.com/800x480/?h&m'
        ];
        ...
        foreach ($vendorNames as $key => $vendorName) {
            ...
            foreach ($vendorProductList as $vendorProductData) {
                ...
                //
                try {
                    $imageUrl = "https://source.unsplash.com/800x480/?" . urlencode($product->name);
