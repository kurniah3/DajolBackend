    ...
    <x-baseview title="{{ __('New Package Order') }}">
        <div class="shadow pb-4 px-2 bg-white rounded">
            <x-stepper.main steps="7" :currentStep="$currentStep">
                <x-slot name="header">
                    <x-stepper.header step="1" title="{{ __('Package Type') }}" />
                    ...
                    <x-stepper.body step="2" nextClick="validateStep2">
                        ...
                        <div class="my-4">
                            <div class="relative">
                                ...
                                @foreach ($orderStops ?? [] as $orderStopKey => $orderStop)
                                    <!-- Timeline items -->
                                    <div class="flex items-start mb-8">
                                        ...
                                        <div class="flex-grow">
                                            ...
                                            <div>
                                                <x-select name="orderStops.{{ $orderStopKey }}.id" :options="$deliveryAddresses"
                                                    :noPreSelect="true" />
                                            </div>
                                        </div>
                                        @if ($orderStopKey != 0 && count($orderStops) > 2)
                                            <div class="ml-2">
                                                <x-buttons.plain wireClick="removeOrderStop('{{ $orderStopKey }}')"
                                                    bgColor="bg-red-600">
