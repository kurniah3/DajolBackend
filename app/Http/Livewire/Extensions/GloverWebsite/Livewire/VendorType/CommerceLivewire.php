...
class CommerceLivewire extends BaseLivewireComponent
{
    ...
    {
        return view('livewire.extensions.glover-website.vendor-types.commerce')->layout('livewire.extensions.glover-website.layouts.app');
    }
